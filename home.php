...
<head>
    ...
    .feature-container {
        ...
        background-image: url('gambar/anime7.jpg');
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="fitur/fitur1.php">Add Video</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="fitur/fitur4.php">Add Comic</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="fitur/fitur2.php">Watch Video</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="fitur/fitur3.php">Read Comic</a>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="fitur/delete.php">Delete</a></li>
  ...
  <div class="row justify-content-center">
      <div class="col-md-3">
          <div class="card feature-card">
              <a href="fitur/fitur1.php" class="text-reset text-decoration-none">
                  <img src="gambar/anime4.jpg" class="card-img-top" alt="Jual Barang">
                  <div class="card-body">
                      <h5 class="card-title text-center">Add Video</h5>
                  </div>
              </a>
          </div>
      </div>
      <div class="col-md-3">
          <div class="card feature-card">
              <a href="fitur/fitur2.php" class="text-reset text-decoration-none">
      ...
      <div class="col-md-3">
        <div class="card feature-card">
            <a href="fitur/fitur3.php" class="text-reset text-decoration-none">
                <img src="gambar/anime8.png" class="card-img-top" alt="Jual Barang">
                <div class="card-body">
    ...
    <div class="col-md-3">
        <div class="card feature-card">
            <a href="fitur/fitur4.php" class="text-reset text-decoration-none">
                <img src="gambar/gambar22.jpg" class="card-img-top" alt="Jual Barang">
                <div class="card-body">
                    <h5 class="card-title text-center">Add Comic</h5>
                </div>
            </a>
        </div>
    </div>
